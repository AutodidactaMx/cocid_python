...
class FormularioPersona:
    ...
    def eliminar_tabla(self):
        ...
        if (estado == 1):
            messagebox.showerror(
                message=f"Existe un error al borrar posiblemente no exista la tabla", title="Error")
        else:
    ...
    def guardar(self):
        ...
        if (afectados == 0):
            messagebox.showerror(
                message=f"Error al guardar verifique que exista la tabla o los datos", title="Error")
        else:
            messagebox.showinfo(
    ...
    def eliminar(self):
        ...
        if (afectados == 0):
            messagebox.showerror(
                message=f"Error al eliminar verifique la clave que no este repetida", title="Error")
        else:
            messagebox.showinfo(
